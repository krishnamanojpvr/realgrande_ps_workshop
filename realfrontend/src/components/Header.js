...
const Header = () => {
    ...
    return (
        <>
            ...
            <div className="mask text-light justify-content-center flex-column text-center" style={{ backgroundColor: 'rgba(30, 140, 0, 0.5)' }}>
                <div className='col'>
                ...
                <div className='justify-content-around align-items-center mt-3'>
                    ...
                    <button className="btn btn-primary ms-3">Notifications
                        {
            ...
            <div className="mask text-light flex-column text-center" style={{ backgroundColor: 'rgba(30, 140, 0, 0.5)' }}>
                <Link type='button' to="/pg" className='btn btn-warning btn-small mt-3 mb-3'>
                    List a house
                </Link>
                <Link type="button" className='btn btn-success btn-small mt-3 ms-3 mb-3' to="/search">
                    Look up a house
                </Link>
